...
public class NetworkManager {
    ...
    /******************************************************************
     * sends off a group of messages
     ******************************************************************/

    public void sendOff(ArrayList<MessagePacket> messagePackets) throws Exception {
        for (MessagePacket p : messagePackets)
        {
            sendOff(p);
        }
    }
    ...
    private void createChannelMap() throws Exception {
        ...
        Message messageZero = new Message(myNode, Message.REQUEST.SEND);
